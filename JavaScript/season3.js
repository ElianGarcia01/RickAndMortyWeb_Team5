...
document.addEventListener('DOMContentLoaded', async function () {
    ...
    // Obtener episodios de la Season 3 (ID 22-31)
    const promises = [];
    for (let i = 22; i <= 31; i++) {
         ...
         <div class="col-md-3 mb-4">
             <div class="card h-100 text-center" data-hover-image="${hoverImage}" data-original-image="${initialImage}">
                 ...
                 <div class="card-footer">
                     <a href="https://stage.rickandmorty.com/videos" class="btn btn-dark m-2">Go to episode</a>
                 </div>
             </div>
         </div>
     `;
    ...
    function displayEpisodes(episodesToDisplay) {
        ...
        // Mostrar mensaje cuando no se encuentran episodios
        if (episodesToDisplay.length === 0) {

            episodesContainer.innerHTML = '<div class="col-12 text-center"><p>No episodes were found for these filters. Please try again with another text search.</p></div>'
            return
        }
